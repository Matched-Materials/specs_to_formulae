...
def main():
    ...
    s_opt_batch.add_argument("--iterations", type=int, default=10, help="Number of optimization iterations per spec.")
    s_opt_batch.add_argument("--initial-points", type=int, default=10, help="Number of initial DOE points per spec.")
